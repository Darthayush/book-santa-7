              ...
              .then((snapshot)=>{
                  snapshot.forEach((doc)=>{
                      ...
                      if(requestStatus === "Book sent"){
                          message= thos.state.donorName + "Sent You Book"
                      }else{
                          message : this.state.donorName + "Has Shown Interest IN The Donor"
                      }
                      db.collection("allNotifications").doc(doc.id).update({
                          "message": message,
                          "notification_statue": "unread",
                          "date": firebaes.firestore.FieldValue.serverTimeStamp,
                      })
                  })
              })
